...
TEXTS: dict[str, str] = {
    ...
    "order.repeat.skipped": "⚠️ Дастнорас: {names}",
    "order.repeat.unavailable": "Такрори фармоиш танҳо барои фармоишҳои анҷомшуда ё бекоршуда дастрас аст.",
    "common.no_access": "Дастрасӣ нест.",
