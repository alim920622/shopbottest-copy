...
TEXTS: dict[str, str] = {
    ...
    "order.repeat.skipped": "⚠️ Mavjud emas: {names}",
    "order.repeat.unavailable": "Buyurtmani takrorlash faqat yakunlangan yoki bekor qilingan buyurtmalar uchun mavjud.",
    "common.no_access": "Ruxsat yoʻq.",
    "chat.closed": "Chat yopilgan.",
    "cart.title.default": "🧺 Savat",
