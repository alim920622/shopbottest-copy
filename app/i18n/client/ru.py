...
TEXTS: dict[str, str] = {
    ...
    "order.repeat.skipped": "⚠️ Недоступно: {names}",
    "order.repeat.unavailable": "Повтор заказа доступен только для завершённых или отменённых заказов.",
    "common.no_access": "Нет доступа.",
    "chat.closed": "Чат закрыт.",
    "cart.title.default": "🧺 Корзина",
